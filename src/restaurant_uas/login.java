...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel12.setText("Created By Agung Yuda Pratama");
        jPanel1.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 360, 500, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icon/bg-login22.png"))); // NOI18N
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(-30, 40, 500, 340));
        ...
        jLabel4.setText("Hello! Welcome to Restaurant");
        ...
        jPanel2.add(labelSignUp, new org.netbeans.lib.awtextra.AbsoluteConstraints(253, 357, 122, -1));
    ...
    private void btn_loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_loginActionPerformed
        ...
        if (txtusername.getText().equals("") && txtpassword.getText().equals("")) {
            ...
            try {
                ...
                java.sql.ResultSet sql = stm.executeQuery("select * from account where username='" + txtusername.getText() + "'");
                if (sql.next()) {
